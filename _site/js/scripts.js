...
$(document).ready(function() {
    ...
    $(window).smartresize(function() {
        if ($(window).width() < 768 && !stickOnMobile) {
            ...
            if ($navbarLogo) {
                $navbarLogo.height(21); // revert the navbar logo height
...
/*-----------------------------------------------------------------------------------*/
/*	PORTFOLIO PRINT SUBMENU
/*-----------------------------------------------------------------------------------*/
$(document).ready( function() {

	$("#sectionprint").click(function(){
		  $(".subfilter").show();
	});
	$("#sectionall").click(function(){
		  $(".subfilter").hide();
	});
	$("#sectionidentity").click(function(){
		  $(".subfilter").hide();
	});
	$("#sectionenvironmental").click(function(){
		  $(".subfilter").hide();
	});
	$("#sectionweb").click(function(){
		  $(".subfilter").hide();
	});
	$("a[data-filter='.advertisements']").click(function(){
		$("#sectionprint").addClass("active");
	});
	$("a[data-filter='.books']").click(function(){
		$("#sectionprint").addClass("active");
	});
	$("a[data-filter='.brochures']").click(function(){
		$("#sectionprint").addClass("active");
	});
	$("a[data-filter='.fliers']").click(function(){
		$("#sectionprint").addClass("active");
	});
	$("a[data-filter='.invitations']").click(function(){
		$("#sectionprint").addClass("active");
	});
	$("a[data-filter='.purchase']").click(function(){
		$("#sectionprint").addClass("active");
	});
	$("a[data-filter='.posters']").click(function(){
		$("#sectionprint").addClass("active");
	});
	$("a[data-filter='.publications']").click(function(){
		$("#sectionprint").addClass("active");
	});
